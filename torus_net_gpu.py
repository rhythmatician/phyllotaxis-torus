...
def parse_args():
    ...
    ap.add_argument(
        "--gpu",
        action="store_true",
        help="Use OpenGL GPU acceleration (UV-texture-based two-pass rendering). Scales to thousands of nodes/edges efficiently.",
    )
    ap.add_argument(
        "--smooth",
        action="store_true",
...
if __name__ == "__main__":
    ...
    # Choose renderer: 2 options only: CPU or GPU (UV-texture-based)
    if args.gpu:
